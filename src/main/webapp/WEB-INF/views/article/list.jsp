...
<!-- left -->
<div class="mainbox col-md-2" ng-controller="CategoryController">
	...
	<form>
		<div class="form-group">
			<input type="text" class="form-control" ng-model="category.title"
				value="{{category.title}}"></input>
			<button class="btn btn-mini" ng-show="userSession.uid != null"
				ng-click="addNewCategory(category)">등록</button>
		</div>
	</form>
</div>
...
<!-- list -->
<div class="articles-wrapper  col-md-10" ng-hide="writeMode || contentMode">
...
<!-- content -->
<div id="articlebox col-md-10" ng-show="contentMode"
	class="mainbox">
